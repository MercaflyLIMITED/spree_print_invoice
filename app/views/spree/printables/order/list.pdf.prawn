...
prawn_document(force_download: true) do |pdf|
  ...
  pdf.repeat(:all) do
    render 'spree/printables/shared/lists/header', pdf: pdf, printable: @doc
  end
  ...
  pdf.grid([1,0], [6,4]).bounding_box do
    ...
    render 'spree/printables/shared/lists/items', pdf: pdf, invoice: @doc

    pdf.move_down 10

    render 'spree/printables/shared/lists/totals', pdf: pdf, invoice: @doc
